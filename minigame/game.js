...
const managerConfig = {
    DATA_FILE_MD5: 'd719821e40a5e5ab',
    CODE_FILE_MD5: 'fa6b0a22c2888edb',
    GAME_NAME: 'webgl',
    APPID: 'wx0a7116d3eb5cda24',
    DATA_FILE_SIZE: '18735066',
    OPT_DATA_FILE_SIZE: '$OPT_DATA_FILE_SIZE',
    DATA_CDN: 'https://a.unity.cn/client_api/v1/buckets/8c27bb95-d0dc-4318-b507-d8171167fabe/release_by_badge/V1/content',
    // 资源包是否作为小游戏分包加载
